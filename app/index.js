...
//  CONSULTA SERVIDOR PARA INICIALIZAÇÃO,plano free somente.
...
export default function Index() {
  ...
  async function iniciarApp() {
    ...
    // roda em segundo plano sem travar abertura
    setTimeout(() => {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        >
          Atenção: este aplicativo é apenas ferramenta de apoio matemático e
          estatístico. Não garante prêmios.
        </Text>
